...
const initBlocks = async (providerWSS, latestBlock, latestCount) => {
    try {
        //pointer
...
module.exports = {getVanity, fixedNoRound2, countdown, getLiveDexPrice, getLatestBlock, getTxFee, initBlocks}