const { getVanity, fixedNoRound2, countdown, getLiveDexPrice, getLatestBlock, getTxFee, getBlockReward, initBlocks } = require('./coreFunctions');
const { addresses, providers, staticData } = require('./staticVariables');
...
describe('Core Functions Test', () => {
    ...
    it('Expect block reward to be equal to or greater than the static block reward', async () => {
        ...
        // this test will also fail if there are no blocks with less than 100 TX
